    ...
    <div className="fixed bottom-6 z-50 w-full pointer-events-none px-6">
      <div className="container mx-auto max-w-7xl relative h-full">
        ...
        <motion.div
          ...
          className="absolute bottom-0 left-0 z-50 pointer-events-auto"
        >
          <motion.a
          ...
          >
            ...
            <span className="absolute left-full ml-3 bg-navy text-white text-xs font-semibold px-3 py-1.5 rounded-md opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap hidden md:block glass-dark shadow-xl">
              Call Us
            </span>
          </motion.a>
        </motion.div>
        ...
        >
          ...
          >
            ...
            ></motion.div>
            <svg className="w-7 h-7 relative z-10 drop-shadow-md" fill="currentColor" viewBox="0 0 24 24">
